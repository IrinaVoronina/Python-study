...
from aiogram.types import reply_keyboard, ReplyKeyboardMarkup, update
...
def start(bot, update):
    update.message.reply_text('Hello, I`m smart password generator. I can help you to create safety password.',reply_markup=markup)
...
async def get_password(message: types.Message):
    ...
    try:
        ...
        if passlength > 15 or passlength < 5:
            ...
            time.sleep(2)
            await message.answer("Would you like to create one more password? :)")
